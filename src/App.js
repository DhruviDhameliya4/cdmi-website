...
var read_our= [
  { icon:<GiTeacher class='s1'></GiTeacher>, 
  ...
  { icon:<HiUserGroup class='s2'></HiUserGroup>, 
  ...
  { icon:<HiComputerDesktop class='s3'></HiComputerDesktop>, 
  ...
  { icon:<MdSupportAgent  class='s4'></MdSupportAgent>, 
  name: 'Industry Experts As Trainers',
          ...
          <div className='container'>
              <div class='test-main'>
                <div class='test-header'>
                        <p class='test1-header'>
                          <hr></hr>
                          <span>HAPPY STUDENTS</span>
                        </p>
                        <p class='test2-header'>
                            <h1>ALUMNI SPEAK</h1>
                        </p>
    ...
    <div class='creative-info'>
      <div class='container'>
          <div class='creative-header'>
            <p class='creative1-header'>
              <hr></hr>
              <span>READ OUR DIFFERENCE</span>
            </p>
            <p class='creative2-header'>
